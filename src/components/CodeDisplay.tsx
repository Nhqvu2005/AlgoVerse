            ...
            <div className="flex items-center gap-2 px-4 py-2.5 border-b border-white/5 bg-darker/50">
                ...
                <div className="ml-auto flex items-center gap-1">
                    <button
                        ...
                        title={copied ? (t as any).detail?.copied || 'Copied!' : (t as any).detail?.copy || 'Copy'}
                    >
                        {copied ? (
                            <>
                                ...
                                <span className="text-success">{(t as any).detail?.copied || 'Copied!'}</span>
                            </>
                        ) : (
                            <>
                                ...
                                <span>{(t as any).detail?.copy || 'Copy'}</span>
                            </>
                        )}
                    </button>
                </div>
